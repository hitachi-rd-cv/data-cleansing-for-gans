...
# this is quote from the shlex module_torch, added in py3.3
...
class SCPClient(object):
    ...
    def __init__(
            self, transport, buff_size=16384, socket_timeout=10.0,
...
def get(
        transport, remote_path, local_path='',
        recursive=False, preserve_times=False
):
